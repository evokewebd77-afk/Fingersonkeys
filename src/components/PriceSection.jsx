...
import { Sparkles, Trophy, Target, Rocket, Star, ChevronRight, Music, Award, Heart, Sprout } from 'lucide-react';
...
const learningPaths = [
    ...
    {
        title: 'Late Bloomers',
        subtitle: 'Adults 25+ (No prior experience needed)',
        icon: Sprout,
        gradient: 'from-emerald-500 to-teal-500',
        description: "It's never too late to begin. Your musical journey starts today.",
        highlights: [
            'Learn at your own comfortable pace',
            'Songs you already love — pop, classical & H(B)ollywood',
            'Stress-free theory, built for adult minds',
            'Prepare for Grade 1–2 exams (optional)'
        ],
        duration: '8–14 months to Grade 1',
...
const PriceSection = () => {
    ...
    return (
        <>
            <section id="pricing" className="pt-20 pb-12 px-4 relative overflow-hidden bg-gradient-to-b from-zinc-950 to-zinc-900">
                {/* Animated Background */}
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-16">
                        {learningPaths.map((path, index) => (
                            ...
                            >
                                {path.popular && (
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white text-xs font-bold rounded-full uppercase tracking-widest shadow-lg z-10 whitespace-nowrap">
                                        <Sparkles size={12} className="inline mr-1" />
                                        Most Popular
                                    </div>
                                )}

                                <div className={`relative h-full rounded-[2rem] overflow-hidden ${path.popular ? 'border-2 border-pink-500/50' : 'border border-zinc-800'} bg-zinc-900/40 backdrop-blur-xl shadow-2xl group-hover:shadow-pink-500/20 transition-all duration-500 flex flex-col`}>
                                    {/* Image Header */}
                                    ...
                                    <div className="p-8 flex flex-col flex-grow">
                                        ...
                                        <div className="mt-auto">
                                            <button
                                                ...
                                                className={`w-full py-4 rounded-2xl font-bold transition-all bg-gradient-to-r ${path.gradient} text-white hover:shadow-lg hover:opacity-90 group-hover:scale-105 transition-transform`}
                                            >
                                                Start Your Journey
                    ...
                    <div className="mt-12 text-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="w-full mb-8 p-6 rounded-2xl bg-zinc-900/40 border border-zinc-800/50"
                        >
                            <p className="text-zinc-500 text-xs md:text-sm leading-relaxed italic">
                                <span className="text-zinc-400 font-bold not-italic underline decoration-pink-500/30 underline-offset-4 mb-2 block uppercase tracking-wider">Disclaimer:</span>
                                The time taken to complete a piano course depends on individual practice, dedication, and attendance. While we provide a structured curriculum, progress varies from student to student. Regular practice and consistent classes are key to achieving milestones. We'll work together to set realistic goals and timelines.
                            </p>
                        </motion.div>
                        ...
                        <motion.button
                            ...
                            className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-pink-500/10 border border-pink-500/30 text-pink-400 font-bold hover:bg-pink-500 hover:text-white transition-all duration-300 shadow-lg shadow-pink-500/10"
                        >
                            Contact us for detailed pricing based on your goals
