...
const AboutSection = () => {
    ...
    return (
        <section id="about" className="py-16 px-4 relative z-10 bg-zinc-900/50 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <h2 className="text-6xl md:text-5xl font-black mb-4 text-white uppercase tracking-tighter font-[var(--font-brand)] tracking-tighter italic">
                            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 pr-2">Fingers on Keys</span>
                        </h2>
                        <div className="w-24 h-1.5 bg-gradient-to-r from-pink-500 to-purple-500 mt-2 mb-8 rounded-full"></div>
