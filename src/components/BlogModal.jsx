            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-10">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-4xl max-h-[90vh] bg-zinc-950 border border-zinc-800 rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-3xl flex flex-col"
                    >
                        {/* Close Button */}
                        <button
                            onClick={onClose}
                        ...
                        {/* Content */}
                        <div className="flex-1 overflow-y-auto p-0 scrollbar-hide flex flex-col">
                            {blog.type === 'iframe' ? (
                                <iframe
                                    src={blog.url}
