...
const FlipCard = ({ benefit }) => {
    ...
    return (
        <div className="perspective">
            ...
            >
                {/* FRONT */}
                <div className="absolute inset-0 backface-hidden p-8 rounded-[2.5rem] bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 border border-pink-500/40 shadow-2xl group">
                    <div className="absolute -inset-0.5 bg-gradient-to-br from-pink-500/30 to-purple-500/30 rounded-[2.5rem] opacity-100 blur-lg transition-opacity duration-500"></div>
                ...
                {/* BACK */}
                <div className="absolute inset-0 backface-hidden rotate-y-180 p-8 rounded-[2.5rem] bg-zinc-900 border border-zinc-800 shadow-xl flex flex-col justify-center group text-left">
                    <div className="relative">
                        <h3 className="text-xl font-bold text-white mb-4">
                            {benefit.title}
                        </h3>
    ...
    return (
        <section className="py-16 px-4 bg-zinc-950/30">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-6xl md:text-5xl font-black text-center text-white mb-4 font-[var(--font-brand)] tracking-tighter uppercase">
                    MUSIC &  IT's <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">  BENEFITS</span>
                </h2>
