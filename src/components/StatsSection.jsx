...
const StatsSection = () => {
    ...
    return (
        <section ref={ref} className="py-12 px-4 relative overflow-hidden bg-zinc-950/50">
            {/* Background Gradient */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-6xl md:text-5xl font-black mb-4 text-white uppercase tracking-tighter font-[var(--font-brand)]">
                        Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Impact</span>
                    </h2>
