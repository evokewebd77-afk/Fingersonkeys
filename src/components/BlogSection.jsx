...
const blogs = [
    ...
    },
    {
        ...
        type: 'iframe',
        url: '/blogs/keys-and-signatures.html',
        fullContent: []
    }
];
...
const BlogSection = () => {
    ...
    return (
        <section id="blogs" className="py-16 px-4 relative z-10 bg-zinc-900/50">
                ...
                <div className="text-center mb-12">
                    ...
                    >
                        <h2 className="text-6xl md:text-5xl font-black mb-4 text-white uppercase tracking-tighter font-[var(--font-brand)]">
                            Latest from the <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Blog</span>
                        </h2>
