                    ...
                    <div className="col-span-1 md:col-span-2 pr-8">
                        ...
                        <div className="flex space-x-4">
                            {[
                                ...
                                { Icon: MessageCircle, href: 'https://wa.me/919560932344', color: 'hover:bg-[#25D366]' },
                            ].map((social, i) => (
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-zinc-400 mb-8">
                            <li className="flex items-center gap-3 group">
                                ...
                                <a href="tel:+919560932344" className="hover:text-white transition-colors font-bold tracking-wider">+91 95609 32344</a>
                            </li>
                            <li className="flex items-center gap-3 group">
                                ...
                                <a href="https://wa.me/919560932344" className="hover:text-white transition-colors font-bold tracking-wider">+91 95609 32344</a>
                            </li>
                            <li className="flex items-center gap-3 group">
