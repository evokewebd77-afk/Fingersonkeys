                    ...
                    {features.map((feature, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                                className={`group relative p-6 rounded-[1.5rem] bg-zinc-900/50 border border-zinc-800 ${colors.glow} transition-all duration-400 backdrop-blur-sm hover:border-pink-500/30`}
                            >
                                {/* Subtle corner accent */}
                                <div className={`absolute top-0 right-0 w-24 h-24 ${colors.bg} rounded-bl-[3rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`} />

                                <div className="relative z-10">
                                    {/* Icon + Number row */}
                                    <div className="flex items-center justify-between mb-4">
                                        <div className={`w-12 h-12 rounded-2xl ${colors.iconBg} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                    ...
                                    <h3 className="text-white font-bold text-base mb-2 group-hover:text-pink-300 transition-colors duration-300">
                                        {feature.title}
                                    </h3>
                                    ...
                                    {/* Bottom accent line */}
                                    <div className={`mt-4 h-0.5 w-0 group-hover:w-full ${colors.iconBg} rounded-full transition-all duration-500`} />
                                </div>
                            </motion.div>
                        );
                    })}
