...
const TestimonialsSection = () => {
    return (
        <section id="reviews" className="py-16 px-4 relative z-10">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h2 className="text-6xl md:text-5xl font-black mb-4 text-white uppercase tracking-tighter font-[var(--font-brand)]">
                        Student <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Reviews</span>
                    </h2>
