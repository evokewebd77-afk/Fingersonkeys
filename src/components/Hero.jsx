                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-6 md:gap-8">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="px-6 md:px-8 py-4 md:py-5 bg-white/5 border border-pink-500/50 rounded-full font-black text-base md:text-lg text-white hover:border-zinc-700/50 transition-all backdrop-blur-md flex items-center gap-3 relative group overflow-hidden uppercase tracking-widest font-[var(--font-brand)]"
                            >
                                <span className="relative z-10">Join as Piano Faculty</span>
                                <div className="w-8 h-8 rounded-full bg-pink-500 text-white flex items-center justify-center relative z-10 group-hover:bg-white group-hover:text-black transition-colors">
