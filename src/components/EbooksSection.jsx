...
const EbooksSection = () => {
    ...
    return (
        <section id="ebooks" className="py-16 px-4 relative z-10 bg-zinc-900">
                        ...
                        >
                            ...
                            <div className="w-full aspect-[3/4] rounded-2xl mb-8 shadow-2xl flex flex-col justify-between transform group-hover:rotate-y-6 transition-all duration-700 relative overflow-hidden group-hover:scale-[1.02]">
                                ...
                                <div className="relative z-10 p-8 pt-10">
                                    <div className="mb-4 inline-block px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/20 text-[8px] font-black text-pink-400 uppercase tracking-widest leading-none">Most Popular</div>
