...
const GallerySection = () => {
    ...
    return (
        <section id="gallery" className="py-16 px-4 bg-zinc-950 relative overflow-hidden">
            {/* Background elements */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 px-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-6xl md:text-5xl font-black text-white uppercase font-[var(--font-brand)] tracking-tighter">
                            The <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 pb-1">Gallery</span>
                        </h2>
